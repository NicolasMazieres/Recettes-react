...
export default function Navbar(props) {
    ...
    const {accueilClicked, entreesClicked, platsClicked, dessertsClicked, saucesPreparationsClicked, cuissonsClicked} = props.setstate;
        ...
        <nav>
            {(isMenuClicked || largeur > 520) && (
                <ul className="nav-list">
                    ...
                    <li className="nav-items" onClick={() => {saucesPreparationsClicked() ; menuClicked()}}>Sauces / Preparations</li>
